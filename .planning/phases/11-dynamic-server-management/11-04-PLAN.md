...
must_haves:
  ...
  key_links:
    - from: "KubernetesManagementService"
      ...
      via: "UpdateConfigMapAsync call after create/delete"
...
- StopServerAsync scales to 0 replicas
- StartServerAsync scales to 1 replica
- RestartServerAsync deletes pods
- Create and delete operations call UpdateConfigMapAsync
  </verify>
  <done>ConfigMap updates on server lifecycle. Start/stop/restart operations implemented. ConfigMap includes both cluster DNS and NodePort endpoints.</done>
</task>
