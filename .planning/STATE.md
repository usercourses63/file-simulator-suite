...
- Phase 13-06: Role-based selectors (GetByRole) for accessibility and maintainability in E2E tests
- Phase 13-06: Page Object Model pattern for all dashboard tabs with data-returning methods
...
- Phase 14-02: FluentFTP 50.x DownloadStream returns bool (not FtpStatus)
...
- Phase 24-01: History tab dropdown filtered to deployed servers only; chart legend filtered to servers with data points
