...
public class FtpProtocolTests
{
    ...
    /// <summary>
    /// Configures FTP client for data connections.
    /// Uses passive mode with NodePort-exposed ports (30100-30110).
    /// </summary>
    private static void ConfigureFtpClient(AsyncFtpClient client)
    {
